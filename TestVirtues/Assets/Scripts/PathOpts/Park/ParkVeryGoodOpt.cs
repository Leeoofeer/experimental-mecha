...
public class ParkVeryGoodOpt : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sceneManagerComponent2.Data = new string[] { "your friend its ashamed for that", "", "and regrets what he did after that", " ", " his couple decided to end the relationship", " ", "but you and your friend know that", " ", "both did the best thing to do" };
