...
public class ParkNeutralOpt : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sceneManagerComponent2.Data = new string[] { "after some time of taking that decision", "", "your friendship breaks apart and", " ", "eachone takes his own path the", " ", "infidelity continues for unknokn time but", " ", "you think that it doesnt consern you" };
