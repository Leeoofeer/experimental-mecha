...
public class ParkBadOpt : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sceneManagerComponent2.Data = new string[] { "her girlfriend doesnt trust what you", "", "said and it gets mad with you", " ", "the infidelity continues as it goes", " ", "the couple melt down after some weeks", " ", "and you think you could do more" };
