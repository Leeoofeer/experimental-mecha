...
public class AbuseBadOpt : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sceneManagerComponent2.Data = new string[] { "after arriving home you turn on the tv", "", "saw on the news that the victim was", " ", "raped and murdered now the feeling of", " ", "guilty starts to overwhelm your mind and", " ", "you only have proof of what happened" };
