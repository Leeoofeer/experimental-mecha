...
public class WalkBadOpt : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sceneManagerComponent2.Data = new string[] { "the purse owners suffer the loss of a", "", "family member because he needed the money", " ", "to pay medical bills of a family member", " ", "you left him with only one thing"," ", "and empty dirty purse" };
