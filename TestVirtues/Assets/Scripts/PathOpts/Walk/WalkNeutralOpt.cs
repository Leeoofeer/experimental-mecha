...
public class WalkNeutralOpt : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sceneManagerComponent2.Data = new string[] { "the owner trace back the purse and", "", "found it but it was too late to pay the", " ", "medical bills and his family member died", " ", "you didnt have the fault but also", " ", "you could do something", " ", " itsnt your fault but you could help" };
