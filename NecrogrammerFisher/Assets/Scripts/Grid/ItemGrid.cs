...
public class ItemGrid : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //Acá inicializamos el grid con 10 columnas y 5 filas puedo hacer variar el tamaño al inizializar
    ...
    public bool PlaceItem(InventoryItem inventoryItem, int posX, int posY, ref InventoryItem overlapItem)
    {
        ...
        RectTransform recTransform = inventoryItem.GetComponent<RectTransform>();
        recTransform.SetParent(this.rectTransform);
        ...
        recTransform.localPosition = position;
        return true;
    }
    ...
    public Vector2 CalculatePositionOnGrid(InventoryItem inventoryItem, int posX, int posY)
    {
        ...
        position.y = -(posY * tileSizeHeight + tileSizeWidth * inventoryItem.itemData.height / 2);
        return position;
    }
